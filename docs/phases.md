...
- [Phase 1: MVP Scan And Quantity Flow](./phases/phase-1.md)
- [Phase 2: Scan Accuracy And Matching](./phases/phase-2.md)
- [Phase 3: Containerized Network Service](./phases/phase-3.md)
...
- Phase 1 builds the smallest useful end-to-end system on host-run service infrastructure.
